...
const upload = multer({
  ...
  fileFilter: (req, file, cb) => {
    ...
    else cb(new Error('Hanya file gambar JPEG, JPG, atau PNG yang diperbolehkan.'));
  }
});

router.get('/', verifyToken, profileController.getProfile);
router.put('/edit', verifyToken, upload.single('profile_image'), profileController.updateProfile);
